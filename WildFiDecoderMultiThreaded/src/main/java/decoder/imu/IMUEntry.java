...
public class IMUEntry {
	...
	private static DecimalFormat dfAccData = new DecimalFormat("#.###########");  // 11 decimal places
	...
	public String serializeAccelerometerData() {
		...
		{
			sb.setLength(0);
			sb.append(dfAccData.format(accXinG)).append(" ")
					.append(dfAccData.format(accYinG)).append(" ")
					.append(dfAccData.format(accZinG));
			return sb.toString();
		}
